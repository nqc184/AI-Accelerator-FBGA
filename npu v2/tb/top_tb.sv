...
module top_tb();
    ...
    //Memory Control
    logic ifm_done_monitor;
    logic wgt_done_monitor;
    logic bias_done_monitor;
    logic ifm_wr_en_monitor;
    logic [`AXI_BURST-1:0] ifm_wr_data_monitor;
    logic wgt_wr_en_monitor;
    logic [`AXI_BURST-1:0] wgt_wr_data_monitor;
    logic bias_wr_en_monitor;
    logic [`AXI_BURST-1:0] bias_wr_data_monitor;

    //AXI STREAM
    logic signed [`AXI_BURST-1:0] ifm_tdata;
    logic ifm_tvalid;
    logic ifm_tlast;
    logic ifm_tready;

    logic signed [`AXI_BURST-1:0] wgt_tdata;
    logic wgt_tvalid;
    logic wgt_tlast;
    logic wgt_tready;

    logic signed [`AXI_BURST-1:0] bias_tdata;
    logic bias_tvalid;
    logic bias_tlast;
    logic bias_tready;
    ...
    top #(
        ...
        .ifm_wr_en_monitor(ifm_wr_en_monitor),
        .ifm_wr_data_monitor(ifm_wr_data_monitor),
        .wgt_wr_en_monitor(wgt_wr_en_monitor),
        .wgt_wr_data_monitor(wgt_wr_data_monitor),
        .bias_wr_en_monitor(bias_wr_en_monitor),
